...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        for (reference, testimg, datapath), mask in tqdm.tqdm(test_loader):
            ...
            bin_genmask[bin_genmask==1] = 255
            bin_genmask = np.transpose(bin_genmask,(1,2,0))
            cv2.imwrite('./result/'+datapath[0], bin_genmask)
